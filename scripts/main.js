...
//const add_dict = {
//    1: ['Find the One Piece TODAY', 'create_your_adventure.png'],
//    2: ['You dont have enough Power to Read this', 'Rise_of_Burger.png'],
//    3: ['Im Chilling here in the Chum Bucket', "Order_Up.png"],
//}

function music_handler(){
    // used to control the different songs
    bone.currentTime=0;
    chad.currentTime=0;
...
let search_num = Object.keys(dict).length;
let cat_num = Math.floor(Math.random() * search_num) + 1;
...
myImage.onclick = () => {
    ...
    cat_num = Math.floor(Math.random() * search_num) + 1;
